...
function remapValueToHIDKeyboardConst(value){
    ...
    let matchingKey = value.split(" ").join("_");
    matchingKey = matchingKey.toUpperCase();
    console.log(value,keycodeMap["KEY_" + matchingKey] )
    if (keycodeMap["KEY_" + matchingKey] != undefined){
        //This key exists
        return "KEY_" + matchingKey;
    }else{
...
//Extraced from ch55x arduino source code
//https://github.com/DeqingSun/ch55xduino/blob/ch55xduino/ch55xduino/ch55x/libraries/Generic_Examples/examples/05.USB/HidMediaKeyboard/src/userUsbHidMediaKeyboard/USBHIDMediaKeyboard.h
